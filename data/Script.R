...
Production <- read.csv("~/Dropbox/Proyectos/Aquaculture/Production.csv", stringsAsFactors=FALSE)
Value <- read.csv("~/Dropbox/Proyectos/Aquaculture/Value.csv", stringsAsFactors=FALSE)
...
TradeQ <- read.csv("~/Dropbox/Proyectos/Aquaculture/Trade Quantity.csv", stringsAsFactors=FALSE)
TradeV <- read.csv("~/Dropbox/Proyectos/Aquaculture/Trade Value.csv", stringsAsFactors=FALSE)  
...
write.csv(TRADE, file = "WORLD_TRADE.csv")
